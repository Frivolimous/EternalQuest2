...
export const ItemList: IItemRaw[] = [
  ...
  { slug: ItemSlug.ALCHEMIST_FIRE, cost: 20, tags: ['Belt', 'Grenade'], action: { slug: 'Grenade', type: 'attack', tags: ['Chemical', 'Fire'], distance: ['b', 1, 2, 3], stats: {baseDamage: {base: 75, inc: 4.45}}, costs: { action: 100 } }, charges: 6 },
  { slug: ItemSlug.TOXIC_GAS, cost: 20, tags: ['Belt', 'Grenade'], action: { slug: 'Grenade', type: 'curse', tags: ['Chemical', 'Curse', 'Toxic'], distance: ['b', 1, 2, 3], effects: ['gassed'], costs: { action: 100 } }, charges: 6 },
  { slug: ItemSlug.HOLY_WATER, cost: 20, tags: ['Belt', 'Grenade'], action: { slug: 'Grenade', type: 'attack', tags: ['Holy', 'Spirit'], distance: ['b', 1, 2, 3], stats: {baseDamage: {base: 68, inc: 4.15}}, effects: ['blinded'], costs: { action: 100 } }, charges: 6 },
